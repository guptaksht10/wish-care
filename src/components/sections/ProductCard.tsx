...
//   return (
//     <div
//       className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group max-w-sm w-full"
...
//         <div
//           className={`w-full h-full bg-gradient-to-br ${image} transition-transform duration-300 ${
//             isHovered ? "scale-105" : ""
//           }`}
//         ></div>
...
//         {/* Stars on Hover */}
//         <div
//           className={`absolute top-3 left-3 flex items-center space-x-0.5 bg-black/50 px-2 py-1 rounded-full transition-opacity duration-300 ${
...
//           }`}
//         >
//           <Button className="bg-white text-base text-gray-800 hover:bg-gray-100 px-4 py-2">
...
//               <DropdownMenuItem>🔗 Share with Friends</DropdownMenuItem>
//               <DropdownMenuItem>❤️ View Who Wishlisted</DropdownMenuItem>
//             </DropdownMenuContent>
//           </DropdownMenu>
//         </div>
